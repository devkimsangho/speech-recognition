...
if __name__ == '__main__':
    ...
    X = pad_sequences(
        sequences=vectorize_data(X_data, vocab=tri_model.key_to_index),
        maxlen=input_length,
        padding='post'
    )
    ...
    X_test = pad_sequences(sequences=vectorize_data(test.tokenized, vocab=tri_model.key_to_index), maxlen=input_length, padding='post')
    X_val = pad_sequences(sequences=vectorize_data(val.tokenized, vocab=tri_model.key_to_index), maxlen=input_length, padding='post')
