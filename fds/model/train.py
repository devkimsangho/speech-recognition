...
from preprocessing import tokenizer, remove_spectial_character
...
if __name__ == '__main__':
    ...
    outlier = datas.get_outlier(dataset=dataset)
    dataset = datas.remove_some_dataset(dataset, under=0, over=outlier['fishing'][1])
    ...
    f = open("{}/trained/input_length".format(CUR_DIR), 'w+')
